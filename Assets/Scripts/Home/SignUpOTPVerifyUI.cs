...
public class SignUpOTPVerifyUI : MonoBehaviour
{
    ...
    private string signUpVerifyUrl = AuthAPI.api + "verify-otp";
    private string signUpResendUrl = AuthAPI.api + "resend-otp";
    ...
    void OnVerifyClicked()
    {
        ...
        StartCoroutine(AuthAPI.PostRequest(signUpVerifyUrl, json,
            (response) => 
            {
    ...
    void OnResendCodeClicked()
    {
        ...
        StartCoroutine(AuthAPI.PostRequest(signUpResendUrl, json,
            (response) =>
            {
                ResponseData responseData = JsonUtility.FromJson<ResponseData>(response);
